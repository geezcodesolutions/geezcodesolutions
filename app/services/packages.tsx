            ...
            >
              ...
              <div className="p-8 py-6">
                <div className="flex items-baseline flex-wrap gap-2">
                  <span className="text-3xl lg:text-4xl font-extrabold text-blue-950">
                    {tier.priceRange}
                  </span>
                  <span className="text-blue-950/70 font-bold">
                    {tier.currency}
                  </span>
                </div>
                <p className="text-xs text-blue-950/70 mt-2 font-medium uppercase tracking-wide">
                ...
                <ul className="space-y-4">
                  {tier.features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="ml-3 text-blue-950/70 text-sm font-medium leading-6">
                        {feature}
                      </span>
                    </li>
                  ))}

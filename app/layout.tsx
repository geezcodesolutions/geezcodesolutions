...
import BgComponent from "./components/AmharicBackground";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >*/}
      <body
        className="flex flex-col min-h-screen bg-linear-to-b from-slate-950 via-blue-950 to-blue-800" // Added flex utility classes
      >
